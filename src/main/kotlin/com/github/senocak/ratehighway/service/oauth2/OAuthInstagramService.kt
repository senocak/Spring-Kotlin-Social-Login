...
import com.github.senocak.ratehighway.domain.OAuthInstagramUserRepository
...
class OAuthInstagramService(
    ...
    private val oAuthInstagramUserRepository: OAuthInstagramUserRepository,
...
): OAuthUserServiceImpl<OAuthInstagramUser, OAuthInstagramUserRepository>(
    repository = oAuthInstagramUserRepository,
    ...
    private val registration: OAuth2ClientProperties.Registration = oAuth2ClientProperties.registration["instagram"] ?: throw Exception("Registration not found")
    private val provider: OAuth2ClientProperties.Provider = oAuth2ClientProperties.provider["instagram"] ?: throw Exception("Provider not found")

    override fun getClassName(): String? = OAuthInstagramUser::class.simpleName

    override fun getUser(entity: OAuthInstagramUser): User {
    ...
    val link: String = "https://www.instagram.com/oauth/authorize?client_id=${registration.clientId}&redirect_uri=${registration.redirectUri}&response_type=code&scope=${registration.scope.joinToString(separator = ",")}"
}